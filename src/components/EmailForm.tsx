...
const EmailForm = ({ setEmail, setIsSubmited }: Props) => {
    ...
    return (
        <div className="flex flex-col sm:flex-row font-medium">
            <form className="text-[#36384e] py-10 sm:py-14 px-6 sm:px-12 max-w-[470px] order-last sm:order-first" onSubmit={handleSubmit}>
                <h1 className="text-[#242742] mb-5 sm:mb-8 text-4xl sm:text-6xl font-bold">Stay updated!</h1>
